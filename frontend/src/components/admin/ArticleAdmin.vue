<template>
    <div class="article-admin">
        <b-form>
            <input type="hidden" name="" id="article-id" v-model="article.id"> 
            ...
            <b-form-group label="Imagem (URL):" label-for="article-image">
                <b-form-input id="article-image" type="text" v-model="article.imageUrl" 
                :readonly="mode === 'remove'" required 
            ...
            <b-form-group v-if="mode === 'save'" label="Categoria:" label-for="article-categoryId">
                <b-form-select 
                id="article-categoryId" :options="categories" v-model="article.categoryId"></b-form-select>
            </b-form-group>
            <b-form-group v-if="mode === 'save'" label="Autor:" label-for="article-userId">
                <b-form-select 
                id="article-category" :options="users" v-model="article.userId"></b-form-select>
            </b-form-group>
...
import VueEditor from "../../config/editor"
export default {
    name: "ArticleAdmin",
    component: VueEditor,
    data: function() {
